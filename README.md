...
* Preparing specific humidity data (climatology and timeseries) to force R0 for the disease model
...
MERRA-2/SIRS model (#2) specific humidity inputs and disease variable outputs are also available on tigress-web at Princeton University: https://tigress-web.princeton.edu/~mvchung/ENSO_disease/paper_MERRA2-SIRS-HKU1-data/
